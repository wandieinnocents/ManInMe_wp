...
<?php if ( ($first_username && $show_subscribe_button) || sby_doing_customizer( $settings ) ) : ?>
    <span class="sby_follow_btn<?php echo esc_attr( $sub_btn_classes ); ?>" <?php echo SBY_Display_Elements::get_subscribe_button_data_attributes( $settings ); ?>>
        <a href="<?php echo esc_url( $subscribe_url ); ?>" <?php echo SBY_Display_Elements::get_subscribe_button_attribute( $settings ); ?> <?php echo $sub_btn_style; ?> target="_blank" rel="noopener"><?php echo SBY_Display_Elements::get_icon( 'youtube', $icon_type );echo esc_html( $subscribe_button_text ); ?></a>
    </span>
<?php endif; ?>
</div>