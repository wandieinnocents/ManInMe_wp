...
class LicenseService extends ServiceProvider {
	...
	public function localized_license_settings($settings) {
		...
		$settings['upgradeUrl']    = sprintf( 'https://smashballoon.com/youtube-feed/pricing/?edd_license_key=%s&upgrade=true&utm_campaign='. sby_utm_campaign() .'&utm_source=settings&utm_medium=upgrade-license', $this->get_license_key() );
		return $settings;
	}
	...
	public function get_license_error_message( $license_data ) {
		...
		$upgrade_url    = sprintf( 'https://smashballoon.com/youtube-feed/pricing/?edd_license_key=%s&upgrade=true&utm_campaign='. sby_utm_campaign() .'&utm_source=settings&utm_medium=upgrade-license', $license_key );
		$renew_url      = sprintf( 'https://smashballoon.com/checkout/?edd_license_key=%s&download_id=%s&utm_campaign='. sby_utm_campaign() .'&utm_source=settings&utm_medium=upgrade-license&utm_content=renew-license', $license_key, $sby_download_id );
		$learn_more_url = 'https://smashballoon.com/doc/my-license-key-wont-activate/?utm_campaign='. sby_utm_campaign() .'&utm_source=settings&utm_medium=license&utm_content=learn-more';
	...
	public function get_renew_url() {
		...
		$url = sprintf(
			'https://smashballoon.com/checkout/?edd_license_key=%s&download_id=%s&utm_campaign='. sby_utm_campaign() .'&utm_source=expired-notice&utm_medium=renew-license',
			$license_key,
			$sby_download_id
		);
